...
!function (a) {
    ...
    return function (a, b) {
            ...
            h.on("paste", function (c) {
                if (f.config.pasteFilter) {
                    ...
                    if ("TD" !== d && "TH" !== d) {
                        ...
                        if (j && j.getData)h = j.getData("text/html"), h ? (i = b("<div>" + h + "</div>"), a(i.get(0))) : (h = j.getData("text/plain"), h && (h = h.replace(/[ ]/g, "&nbsp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "</p><p>"), g = "<p>" + h + "</p>", g = g.replace(/<p>(https?:\/\/.*?)<\/p>/gi, function (a, b) {
        ...
        a.UI = {}, a.UI.menus = {
            ...
            bgcolor: {
                normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-brush"></i></a>', selected: ".selected"
            },
            strikethrough: {
        ...
        a.createMenu(function (c) {
            ...
            if (c(e)) {
                ...
                b.each(i, function (c, e) {
                    ...
                    var c = b(a.currentTarget), d = c.attr("commandValue"), e = document.createElement("img");
                    e.onload = function () {
                        f.command(a, "InsertImage", d), e = null
                    }, e.onerror = function () {
                        f.command(a, "insertHtml", "<span>" + d + "</span>"), e = null
                    }, e.src = d, a.preventDefault()
        ...
        a.plugin(function () {
            ...
            c.onload || (c.onload = function (b, c) {
                a.log("上传结束，返回结果为 " + b);
                var d, e = this;
                0 === b.indexOf("error|") ? (a.warn("上传失败：" + b.split("|")[1]),
                    alert(b.split("|")[1])) : (a.log("上传成功，即将插入编辑区域，结果为：" + b), d = document.createElement("img"), d.onload = function () {
        ...
        if (!window.FileReader || !window.FormData) {
            ...
            c.fn = c.prototype, c.fn.clear = function () {
                ...
                function a() {
                    ...
                    a && (h.call(d, a), c.clear(), c.hideModal())
                }
        ...
        a.userAgent.indexOf("MSIE 8") > 0 || a.plugin(function () {
            ...
            function h(a) {
                var c = !1;
                return j.emotionUrls ? (b.each(j.emotionUrls, function (b, d) {
                    var e = !1;
                    return a === d && (c = !0, e = !0), e ? !1 : void 0
                }), c) : c
            }

            var i, j = this, k = j.txt, l = k.$txt, m = j.useMaxHeight ? l.parent() : l, n = (j.$editorContainer, !1), o = b('<div class="img-drag-point"></div>'), p = b('<div class="txt-toolbar"></div>'), q = b('<div class="tip-triangle"></div>'), r = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'), s = b('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'), t = b('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>'), u = b('<a href="#"><i class="wangeditor-menu-img-align-left"></i></a>'), v = b('<a href="#"><i class="wangeditor-menu-img-align-center"></i></a>'), w = b('<a href="#"><i class="wangeditor-menu-img-align-right"></i></a>'), x = !1;
